...
public class EventListnerClass implements ITestListener{
	...
	public void configureReport()
	{
		...
		String reportName = "APIAutomationTestReport-" +/*+ timestamp + */".html";
		...
		reports.setSystemInfo("Tester Name:", "Nitesh");
	...
	{		
      ...
      //  test.log(Status.INFO,"TestExecution Started");
	...
	{		
		...
		test = reports.createTest(Result.getName());
		test.log(Status.PASS, MarkupHelper.createLabel("Test case is: " + Result.getName() ,ExtentColor.GREEN));
	}		
